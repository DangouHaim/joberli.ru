                        ...
                        <ul class="shop-nav" style="margin-left: 30px">
                          ...
                          <? if (is_user_logged_in()) : ?>
                            ...
                            <li class="messageClosedDialog elMes display-none-md">
                              ...
                              <a href="#" class="mouseHover" data-discription="Сообщения"><i class="fad fa-envelope-o" style="font-size: 20px;"></i></a>
                          ...
                          <? if (is_user_logged_in()) : ?>
                            ...
                            <li class="mouseHover display-none-md" data-discription="Сохранённые посты">
                              ...
                              <a href="/saved-posts/"><i class="fad fa-heart-o" style="font-size: 18px;"></i></a>
      ...
      <nav id="mmenu" class="hidden">
        <ul>
          ...
          if (is_user_logged_in()) {
            ...
            echo "<li><a href='/addAccount/'>Ваш баланс: " . getAccount(get_current_user_id()) . " ₽</a></li>";
          }
          ?>
          ...
          <? endif ?>
          <? if(is_user_logged_in()) : ?>
            <li><a href="/messages/"><i class="fad fa-envelope-o fix" style="font-size: 20px;"></i>Сообщения</a></li>
          <? endif ?>
          <li><a href="/saved-posts/"><i class="fad fa-heart-o fix" style="font-size: 18px;"></i>Сохранённые посты</a></li>
