  ...
  <div class="edd_download_inner">
    ...
    <div class="product-details">
      ...
      <div class="details-bottom">
        ...
        <a href="#" data-id="<? echo get_the_ID(); ?>" class="post-save" title="<?php esc_attr_e('Удалить из сохранённого','olam'); ?> "><i class="demo-icons icon-like"></i><? echo get_saved_posts_count(get_the_ID()) ?></a>
