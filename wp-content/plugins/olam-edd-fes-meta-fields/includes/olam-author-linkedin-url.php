<?php
class Olam_Author_Linkedin_Url extends FES_Field {
	...
	public $supports = array(
		...
		'template'   => 'author_linkedin_url',
		'title'       => 'author_linkedin_url',
		'phoenix'    => true,
	);
	...
	public function set_title() {
		$title = _x( 'LinkedIn Url', 'FES Field title translation', 'olam-edd-fes-meta-fields' );
