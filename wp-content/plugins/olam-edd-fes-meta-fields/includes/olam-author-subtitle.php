<?php
class Olam_Author_Subtitle extends FES_Field {
	...
	public $supports = array(
		...
		'template'   => 'author_page_subtitle',
		'title'       => 'author_page_subtitle',
		'phoenix'    => true,
	);
	...
	public function set_title() {
		$title = _x( 'Author Subtitle', 'FES Field title translation', 'olam-edd-fes-meta-fields' );
