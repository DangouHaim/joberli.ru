<?php
class Olam_Author_Gplus_Url extends FES_Field {
	...
	public $supports = array(
		...
		'template'   => 'author_gplus_url',
		'title'       => 'author_gplus_url',
		'phoenix'    => true,
	);
	...
	public function set_title() {
		$title = _x( 'Google Plus Url', 'FES Field title translation', 'olam-edd-fes-meta-fields' );
