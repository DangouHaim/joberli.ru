<?php
class Olam_Author_Title extends FES_Field {
	...
	public function set_title() {
		$title = _x( 'Author Title', 'FES Field title translation', 'olam-edd-fes-meta-fields' );
	...
	public function sanitize( $values = array(), $save_id = -2, $user_id = -2 ) {
		...
		if ( !empty( $values[ $name ] ) ) {
			...
			$values[ $name ] = wp_kses( $values[ $name ],array('span'=>array()) );
		}
