<?php
class Olam_Author_Youtube_Url extends FES_Field {
	...
	public $supports = array(
		...
		'template'   => 'author_youtube_url',
		'title'       => 'author_youtube_url',
		'phoenix'    => true,
	);
	...
	public function set_title() {
		$title = _x( 'Youtube Url', 'FES Field title translation', 'olam-edd-fes-meta-fields' );
